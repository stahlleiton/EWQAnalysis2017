...
//=========  (Thu Mar 28 20:02:04 2019) by ROOT version 6.12/07
   ...
   0.0450975,
   0.0472572};
   TGraphAsymmErrors *grae = new TGraphAsymmErrors(10,hForwardBackwardRatio_lmkvhzbe_pdf_fx3024,hForwardBackwardRatio_lmkvhzbe_pdf_fy3024,hForwardBackwardRatio_lmkvhzbe_pdf_felx3024,hForwardBackwardRatio_lmkvhzbe_pdf_fehx3024,hForwardBackwardRatio_lmkvhzbe_pdf_fely3024,hForwardBackwardRatio_lmkvhzbe_pdf_fehy3024);
   grae->SetName("hForwardBackwardRatio_lmkvhzbe_pdf");
   grae->SetTitle("");
